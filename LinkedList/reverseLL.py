...
def reverse_linked_list_brute(head):
...
def reverse_linked_list_optimal(head):
    # Base case:
    ...
    new_head = reverse_linked_list_optimal(head.next)
...
head = reverse_linked_list_brute(head)
